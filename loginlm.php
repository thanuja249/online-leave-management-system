<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT * FROM signup WHERE name= '$myusername' or id='$myusername' and password = '$mypassword'";
...
<form action="" method="POST">
 <div class="container">
  ...
  <div class="container" style="background-color:#f1f1f1">
      ...
      <h3><span>Or</span></h3>
	  <div class="create">
    <a href="reglm.php" style="font-size:20px;">CREATE NEW ACCOUNT</a> </div></div>
  </form>
</body>
</html>
